...
public final class FabricComponent extends PlatformComponent {

    private final FabricComponentAdapter adapter;
    ...
    public FabricComponent(final FabricComponentAdapter adapter) {
