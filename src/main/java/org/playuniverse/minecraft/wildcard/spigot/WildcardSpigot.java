...
public final class WildcardSpigot extends JavaPlugin implements IWildcardPlugin {
    ...
    public void onSetup() {
        ...
        setup = true;
        core.preSetup();
        service.replace(new SpigotService(adapter.getComponentParser(), Singleton.get(PluginSettings.class)));
        Bukkit.getPluginManager().registerEvents(new PlayerListener(getAdapter(), core.getDatabase()), this);
