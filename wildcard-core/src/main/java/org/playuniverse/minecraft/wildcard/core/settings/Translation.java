...
public final class Translation {
    ...
    public PlatformComponent[] translateComponent(final PlatformComponentParser parser, final String text) {
        return parser.parse(translate(text));
    }

    public PlatformComponent[] translateComponent(final PlatformComponentParser parser, final String text, final Object... placeholders) {
