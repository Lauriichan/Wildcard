...
public final class SpigotComponent extends PlatformComponent {

    private final TextComponent component = new TextComponent();
    private final SpigotComponentAdapter adapter;

    private PlatformClickEvent clickEvent;
    private PlatformHoverEvent hoverEvent;
    private Color color;

    public SpigotComponent(SpigotComponentAdapter adapter) {
    ...
    public void setColor(Color color) {
        this.color = color;
        adapter.getSpigotAdapter().applyColor(component, color);
    }
